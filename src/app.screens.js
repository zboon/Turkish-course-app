...
function startReview(){
  /* A sitting is REP_SESSION words, like Tekrar motoru's; more by choice. */
  const q=shuffle(dueList().slice(0,REP_SESSION));
